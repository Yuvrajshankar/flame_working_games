...
class MyGame extends FlameGame
  ...
  void _generateGameComponents(Vector2 generateFromPosition) {
    ...
    _addComponentToTheGame(
      ColorSwitcher(position: generateFromPosition + Vector2(0, 0)),
    );
    _addComponentToTheGame(
      CircleRotator(
    ...
    _addComponentToTheGame(
      StarComponent(position: generateFromPosition + Vector2(0, -200)),
    );
  }
  ...
  void checkToGenerateNextBatch(StarComponent starComponent) {
    final allStarComponents = _gameComponents
        .whereType<StarComponent>()
        .toList();
